#// contact me on discord ignatiosg#1030... :)! 
...
def banner():
    ...
    print(bcolors.GREEN + '+[+[+[ made by ignatios(discord->ignatiosg#1030) ]+]+]+')
    print(bcolors.GREEN + '''
                     \|/
                       `--+--'
                          |
            ...
            |###########################|
             \#########################/
              `.#####################,'
                `._###############_,'
                   `--..#####..--'                                  (-.--.-. -. -. -)
*.______________________________________________________________,' (AnonymousOpGreece)
                                                                    (--'-.-.-.-.-''') 
